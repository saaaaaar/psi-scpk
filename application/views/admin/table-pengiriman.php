            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Data Distribusi Bantuan Bencana</h4>
                                            ...
                                            <tr>
                                                ...
                                                <?php
                                                    foreach ($distribusi as $d) {
                                                        if($d['nama_bantuan'] != "uang"){
                                                            echo "<th>Total ".$d['nama_bantuan']." (lembaran)</th>";
                                                        }
                                                    }
                                                ?>
                                                <th>Total Uang (Rp)</th>
                                                <th>Rincian Distribusi</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            ...
                                            $no++;?>
                                                <tr>
                                                    ...
                                                    foreach ($distribusi as $d) {
                                                        if($d['nama_bantuan'] != "uang"){
                                                            echo "<td>".$d['jumlah_barang']."</td>";
                                                        }
                                                    }
                                                    ?>
                                                    <td><?php echo $d['jumlah_uang']?></td>
                                                    <td><a href="/psi-scpk/bantuan/rincian"><button class="btn btn-danger btn">3/10</button></a></td>
                                                </tr>
                                            <?php }?>
                                        </tbody>
                                    </table>
